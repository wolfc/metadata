...
public class JBossEjb3MetaDataParser extends AbstractEjbJarMetaDataParser
{
   ...
   @Override
   public JBossEjbJarMetaData parse(XMLStreamReader reader) throws XMLStreamException
   {
      throw new UnsupportedOperationException("org.jboss.metadata.ejb.parser.jboss.ejb3.JBossEjb3MetaDataParser.parse");
   }

   public JBossEjbJarMetaData parse(final XMLStreamReader reader, final DTDInfo info) throws XMLStreamException
   {
      ...
      final JBossEjbJarMetaData metaData = new JBossEjbJarMetaData(ejbJarVersion);
